...
{
	/**
	 * Returns an image identifier representing the image obtained from the
	 * given filename. This provides GD with support for processing BMP images.
	 *
	 * Losely based on DHKold's 2.0B version found at comments section:
